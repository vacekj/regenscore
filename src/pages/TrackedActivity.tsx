...
const TrackedActivity = () => {
  return (
    <Flex
      ...
      <Text mb="46px" fontSize='20' fontFamily="Inter-Regular">Check out the details of your activities</Text>

      <TableContainer borderRadius="8" bg="brand.beige.400" shadow= "0px 4px 4px rgba(0, 0, 0, 0.25)" padding="28px 32px 16px 32px" mb="94px">
    <Table size='lg'>
      <Thead>
        <Tr>
          <Th style={{ borderBottom: '1px solid #F5B333' }} fontFamily="Inter-Bold" fontSize="24px" color="brand.deepGreen.400" textTransform="capitalize" paddingLeft="0px">Taxanomy</Th>
          <Th style={{ borderBottom: '1px solid #F5B333' }} fontFamily="Inter-Bold" fontSize="24px" color="brand.deepGreen.400" textTransform="capitalize">Network</Th>
          <Th style={{ borderBottom: '1px solid #F5B333' }} fontFamily="Inter-Bold" fontSize="24px" color="brand.deepGreen.400" textTransform="capitalize">Behavior</Th>
          <Th style={{ borderBottom: '1px solid #F5B333' }} fontFamily="Inter-Bold" fontSize="24px" color="brand.deepGreen.400" textTransform="capitalize">Value</Th>
          <Th style={{ borderBottom: '1px solid #F5B333' }} fontFamily="Inter-Bold" fontSize="24px" color="brand.deepGreen.400" textTransform="capitalize" display="flex" alignItems="center" gap="8px">Points Earned<Check status={"WARNING2"} /></Th>
        </Tr>
      </Thead>
      <Tbody>
        <Tr >
          <Td paddingLeft="0px"><Text variant="contribution" borderRadius="30px" border="1px solid" padding="7px 16px" display="flex" justifyContent="center" alignItems="center">Contribution</Text></Td>
          <Td display="flex" gap="8px" alignItems="center" height="83px"><OptimismLogo/>Optimism</Td>
        ...
        <Tr>
          <Td paddingLeft="0px"><Text variant="governance" borderRadius="30px" border="1px solid" padding="7px 16px" display="flex" justifyContent="center" alignItems="center">Governance</Text></Td>
          <Td display="flex" gap="8px" alignItems="center" height="83px"><OptimismLogo/>Optimism</Td>
        ...
        <Tr>
          <Td paddingLeft="0px"><Text variant="outreach" borderRadius="30px" border="1px solid" padding="7px 16px" display="flex" justifyContent="center" alignItems="center">Outreach</Text></Td>
          <Td display="flex" gap="8px" alignItems="center" height="83px"><GitcoinLogo/>Gitcoin</Td>
          <Td>Gitcoin Project owner</Td>
          <Td>Yes</Td>
          <Td>150 Points</Td>
        </Tr>
        <Tr>
          <Td paddingLeft="0px"><Text variant="security" borderRadius="30px" border="1px solid" padding="7px 16px" display="flex" justifyContent="center" alignItems="center">Security</Text></Td>
          <Td display="flex" gap="8px" alignItems="center" height="83px"><OptimismLogo/>Optimism</Td>
        ...
        <Tr>
          <Td paddingLeft="0px"><Text variant="security" borderRadius="30px" border="1px solid" padding="7px 16px" display="flex" justifyContent="center" alignItems="center">Security</Text></Td>
          <Td display="flex" gap="8px" alignItems="center" height="83px"><EthLogo/>Ethereum</Td>
          <Td>Staked Ethereum</Td>
          <Td>Yes</Td>
          <Td>150 Points</Td>
        </Tr>
        <Tr>
          <Td paddingLeft="0px"><Text variant="unitization" borderRadius="30px" border="1px solid" padding="7px 16px" display="flex" justifyContent="center" alignItems="center">Unitization</Text></Td>
          <Td display="flex" gap="8px" alignItems="center" height="83px"><OptimismLogo/>Optimism</Td>
        ...
        <Tr>
          <Td paddingLeft="0px"><Text variant="outreach" borderRadius="30px" border="1px solid" padding="7px 16px" display="flex" justifyContent="center" alignItems="center">Outreach</Text></Td>
          <Td display="flex" gap="8px" alignItems="center" height="83px"><GivethLogo/>Giveth</Td>
...
const GivethLogo = () => (
  ...
  <g id="Vector">
  <path d="M20.136 13.3675C20.087 13.5947 20.0481 13.8249 19.9872 14.0487C19.3411 16.4252 17.9337 18.2015 15.7487 19.336C14.1164 20.1838 12.3752 20.4385 10.5654 20.1137C8.47239 19.7386 6.77168 18.6947 5.46062 17.0202C5.44856 17.0048 5.45661 16.9512 5.47233 16.9388C7.64228 15.3121 9.81373 13.6875 11.9867 12.0651C12.0375 12.0305 12.0991 12.0151 12.1603 12.0217C14.8289 12.4024 17.4971 12.7855 20.1649 13.1709L20.136 13.3675Z" fill="#FCFCFF"/>
  <path d="M13.3737 3.85434C13.5956 3.90366 13.8189 3.94594 14.0389 4.00226C15.3274 4.33253 16.4707 4.93814 17.4688 5.8191C17.4754 5.82579 17.4817 5.83285 17.4876 5.84024L16.6909 6.43521C16.5175 6.56471 16.3449 6.69537 16.1699 6.82269C16.1593 6.82757 16.1477 6.82978 16.1361 6.82912C16.1244 6.82847 16.1131 6.82498 16.1031 6.81894C15.0855 6.02094 13.9335 5.55547 12.6471 5.42255C9.76887 5.12602 6.98248 6.79377 5.89632 9.47425C5.22377 11.1351 5.22461 12.805 5.87697 14.475C5.88321 14.4908 5.879 14.5233 5.86761 14.5312C5.43291 14.859 4.99703 15.1857 4.55998 15.5112C4.55572 15.5144 4.55065 15.5167 4.54096 15.5225C4.51299 15.4616 4.48453 15.4024 4.45838 15.3424C3.73463 13.6819 3.55678 11.9648 3.94896 10.1954C4.765 6.51724 7.9711 3.86911 11.7469 3.75221C12.1287 3.74046 12.5119 3.77868 12.8943 3.79375L12.9724 3.79659L13.3737 3.85434Z" fill="#FCFCFF"/>
  <path d="M16.8004 9.37671C16.8499 9.03721 17.0155 8.72536 17.2691 8.49425C17.5226 8.26313 17.8485 8.12703 18.1911 8.10912C18.5337 8.0912 18.8719 8.19257 19.1481 8.39597C19.4244 8.59938 19.6217 8.89224 19.7063 9.22473C19.791 9.55721 19.7578 9.90876 19.6124 10.2195C19.4671 10.5303 19.2185 10.7811 18.9091 10.9293C18.5996 11.0774 18.2484 11.1137 17.9152 11.032C17.582 10.9503 17.2874 10.7557 17.0816 10.4812C16.9644 10.3247 16.8792 10.1465 16.831 9.95698C16.7827 9.76746 16.7723 9.57027 16.8004 9.37671Z" fill="#FCFCFF"/>
  </g>
  </g>
  </svg>
);
...
const EthLogo = () => (
  ...
  <path d="M11.9983 3L11.8804 3.42374V15.7197L11.9983 15.8442L17.3967 12.4704L11.9983 3Z" fill="#5326EC" fill-opacity="0.2"/>
  <path d="M11.9985 3L6.6001 12.4704L11.9985 15.8442V9.87611V3Z" fill="#5326EC"/>
  <path d="M11.9986 16.9248L11.9321 17.0105V21.3906L11.9986 21.5958L17.4002 13.5527L11.9986 16.9248Z" fill="#5326EC" fill-opacity="0.4"/>
  <path d="M11.9985 21.5958V16.9248L6.6001 13.5527L11.9985 21.5958Z" fill="#5326EC"/>
  <path d="M11.9985 15.845L17.3969 12.4712L11.9985 9.87695V15.845Z" fill="#5326EC"/>
  <path d="M6.6001 12.4712L11.9984 15.845V9.87695L6.6001 12.4712Z" fill="#5326EC" fill-opacity="0.2"/>
  </g>
  <defs>
  <clipPath id="clip0_685_548">
  <rect width="10.8" height="18.6" fill="white" transform="translate(6.6001 3)"/>
  </clipPath>
  </defs>
  </svg>
);